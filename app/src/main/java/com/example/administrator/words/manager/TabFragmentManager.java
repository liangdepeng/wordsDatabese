...
public class TabFragmentManager implements RadioGroup.OnCheckedChangeListener {
    ...
    private static final int TAB_INPUT_WORDS = 0;
    private static final int TAB_RECITE_WORDS = 1;
    private static final int TAB_SELF_WORDS = 2;
    ...
    public TabFragmentManager(MainActivity mainActivity, int fragmentId) {
