...
public class VolleyRequestParams {
     ...
     */
    public VolleyRequestParams(String requestUrl, Class<?> parseClass) {
     ...
     */
    public VolleyRequestParams(String requestUrl, int requestMethod, Class<?> parseClass) {
     ...
     */
    public VolleyRequestParams addParams(String key, Object value) {
        if (paramsMap == null) {
